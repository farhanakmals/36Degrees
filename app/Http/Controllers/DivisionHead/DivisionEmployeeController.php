...
class DivisionEmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('division.employer')->with('success_add_employer', 'Karyawan berhasil ditambahkan.');
            ...
            DB::rollBack();
            return redirect()->route('division.employer')->with('error', 'Karyawan gagal ditambahkan.');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('division.employer')->with('success_edit_employer', 'Karyawan berhasil diubah.');
            ...
            DB::rollBack();
            return redirect()->route('division.employer')->with('error', 'Karyawan gagal diubah.');
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('division.employer')->with('success_delete_employer', 'Karyawan berhasil dihapus.');

        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->route('division.employer')->with('error', 'Karyawan gagal dihapus.');
        }
    }
    ...
    private function validateRequest(Request $request)
    {
        return $request->validate([
            ...
            'jabatan' => ['required', 'string', 'in:employee'],
        ], [
            ...
            'jabatan.in' => 'Jabatan harus berupa employee.',
        ]);
    }
}
