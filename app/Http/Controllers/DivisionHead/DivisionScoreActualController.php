...
class DivisionScoreActualController extends Controller
{
    public function index()
    {
        $userPosition = Auth::user()->position;

        $employees = ScoringPeriod::with('user', 'scores')
        ...
        return view('division_head.score_actual', compact('employees', 'aspects'));
    }
    ...
    public function create()
    {
        ...
        return view('division_head.add_score_actual', compact('employees', 'aspek'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('division.score_actual')->with('success_add_score', 'Scores added successfully.');
    ...
    public function edit($id)
    {
        ...
        return view('division_head.edit_score_actual', compact('data', 'employees', 'aspek'));
    }
    ...
    public function update(Request $request, $id, $userId)
    {
        try {
            ...
            return redirect()->route('division.score_actual')->with('success_update', 'Score updated successfully.');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('division.score_actual')->with('success_delete', 'Score deleted successfully.');
