...
class DivisionScoreResultController extends Controller
{
    public function index(Request $request)
    {
        ...
        $rawData = DB::table('employee_scores')
            ...
            ->where('users.position', $userPosition)
        ...
        return view('division_head.score_result', compact('grouped', 'termin', 'tahun', 'tahunList'));
    }
}
