            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
                <ul class="space-y-2 font-medium">
                    ...
                    @if ($user->role === 'division_head')
                        <li>
                            <a href="{{ route('division.score_actual') }}" class="flex items-center p-2 text-gray-900 rounded-lg group {{ request()->routeIs('division.score_actual') || request()->routeIs('division.score_actual.create') || request()->routeIs('division.score_actual.edit') ? 'bg-[#e3c8ab]' : ' hover:bg-gray-100' }}">
                                <div class="p-2.5 rounded-lg shadow {{ request()->routeIs('division.score_actual') || request()->routeIs('division.score_actual.create') || request()->routeIs('division.score_actual.edit') ? 'bg-white' : 'bg-[#e3c8ab]' }}">
                        ...
                        <li>
                            <a href="{{ route('division.employer') }}" class="flex items-center p-2 text-gray-900 rounded-lg group {{ request()->routeIs('division.employer') ? 'bg-[#e3c8ab]' : ' hover:bg-gray-100' }}">
                                <div class="p-2.5 rounded-lg shadow {{ request()->routeIs('division.employer') ? 'bg-white' : 'bg-[#e3c8ab]' }}">
