    ...
    <section>
        <div class="flex flex-col gap-3">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <a href="{{ route('division.score_actual.create') }}" class="flex gap-2 text-white bg-[#B96D40] h-fit font-medium rounded-lg text-sm p-2.5">
                            ...
                            <tbody>
                                @foreach ($employees as $item)
                                    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                                        ...
                                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                            <div class="flex gap-2">
                                                <a href="{{ route('division.score_actual.edit', $item->id) }}" class="cursor-pointer p-2 text-xs font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow-sm">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <form id="form-delete-score-{{ $item->id }}" action="{{ route('division.score_actual.destroy', $item->id) }}" method="post">@csrf @method('delete')</form>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
